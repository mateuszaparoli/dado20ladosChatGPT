...
def sortear_prato():
    ...
    tk.Label(nova_janela, text='O prato sorteado é:').pack(pady=10)
    tk.Label(nova_janela, text=prato_sorteado).pack(pady=10)
...
style.configure('TButton', foreground='black', background='white', font=('Helvetica', 14))

# Criando o botão na janela principal
botao_sortear = ttk.Button(root, text='Sortear', command=sortear_prato)
